    ...
    <>
      ...
      <section className="relative overflow-hidden bg-ambient-warm">
        ...
        <div className="relative mx-auto max-w-[1200px] px-4 py-20 lg:py-28">
          <FadeIn direction="up">
            <p className="mb-4 inline-flex items-center gap-2 rounded-full bg-forest/[0.04] px-4 py-1.5 text-[0.6rem] font-semibold uppercase tracking-[0.3em] text-forest/60">
              The Re-Self Journal
            </p>
