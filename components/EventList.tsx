                  ...
                  {!isPast ? (
                    <>
                      {event.registrationUrl && (
                        <span className="inline-flex items-center gap-1.5 rounded-full bg-forest px-5 py-2 text-xs font-semibold text-white shadow-sm transition-all duration-200 group-hover:bg-forest-light group-hover:shadow-md">
                          Register
                      ...
                      <span className="inline-flex items-center gap-1.5 rounded-full border border-forest/20 px-4 py-2 text-[11px] font-semibold text-forest transition-colors duration-200 group-hover:border-forest/40 group-hover:bg-forest/[0.04]">
