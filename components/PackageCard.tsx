  ...
  return (
    <div
      className={`group relative flex flex-col rounded-2xl border transition-all duration-500 hover:-translate-y-1 hover:shadow-xl ${
        isHighlighted
          ? "mt-6 border-white/20 bg-gradient-to-b from-[#243720] via-[#3a5032] to-[#243720] text-white shadow-2xl shadow-forest/30 scale-[1.02] z-10 ring-1 ring-white/10"
    ...
    >
      ...
      {isHighlighted && (
        <>
          <div
            aria-hidden="true"
            className="absolute left-0 right-0 top-0 h-[2px] rounded-t-2xl bg-gradient-to-r from-transparent via-white/40 to-transparent"
          />
          <div className="absolute -top-4 left-1/2 z-30 -translate-x-1/2">
            <span className="inline-flex items-center gap-1.5 whitespace-nowrap rounded-full border border-white/30 bg-white/15 px-5 py-1.5 text-[11px] font-bold uppercase tracking-widest text-white shadow-lg shadow-black/20 backdrop-blur-sm">
              <span
                aria-hidden="true"
      ...
      <div className="p-8 pt-6">
        <button
          ...
          className={`relative flex w-full min-h-[48px] items-center justify-center rounded-full text-sm font-semibold uppercase tracking-wider transition-all duration-300 hover:-translate-y-0.5 active:scale-[0.98] disabled:opacity-60 disabled:cursor-wait ${
            isHighlighted
              ? "bg-white text-forest shadow-lg shadow-black/20 hover:bg-white/90 hover:shadow-xl hover:shadow-black/25"
